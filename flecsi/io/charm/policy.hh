...
struct charm_policy_t {
  ...
  void add_process_topology(legion_hdf5_t & hdf5_file) {
    ...
    data::charm::unique_index_space process_topology_file_is =
  ...
  //----------------------------------------------------------------------------//
  // Implementation of legion_io_policy_t::checkpoint_index_topology_field.
  //----------------------------------------------------------------------------//
  void checkpoint_index_topology_field(hdf5_t & hdf5_file,
    ...
    hdf5_region_vector.push_back(checkpoint_region);
    checkpoint_data(hdf5_file, file.index_space, hdf5_region_vector, true);
  } // checkpoint_index_topology_field
  ...
  //----------------------------------------------------------------------------//
  // Implementation of legion_io_policy_t::recover_index_topology_field.
  //----------------------------------------------------------------------------//
  ...
  void checkpoint_data(legion_hdf5_t & hdf5_file,
    ...
    auto task_id =
      attach_flag
        ? execution::charm::task_id<checkpoint_with_attach_task, loc | inner>
        : execution::charm::task_id<checkpoint_without_attach_task,
            loc | leaf>;
  ...
  void recover_data(legion_hdf5_t & hdf5_file,
    ...
    auto task_id =
      attach_flag
        ? execution::charm::task_id<recover_with_attach_task, loc | inner>
        : execution::charm::task_id<recover_without_attach_task, loc | leaf>;
...
private:
  struct topology_data {
    data::charm::unique_index_space index_space;
